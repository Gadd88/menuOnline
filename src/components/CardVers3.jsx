...
const CardVers3 = ({producto}) => {
  ...
  return (
    <div className="1fm-product flex flex-shrink-0 p-2 md:p-4 border-b-2 border-gray-400 relative cursor-pointer">
        <button className="absolute top-2 right-2 bg-green-700 rounded-full p-1 text-white text-lg w-8 h-8 active:bg-green-400" onClick={()=>agregarPedido(producto)}>+</button>
